            ...
            <section className="relative w-full min-h-[calc(100vh-2.75rem)] snap-start flex flex-col items-center justify-center text-center px-6 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto space-y-6">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        A real-time, visual programming environment for WebGL and compute shaders.
                        Connect nodes, compile instantly, and create stunning visual effects right in your browser.
                    </p>
            ...
            <section className="relative w-full min-h-[calc(100vh-2.75rem)] snap-start flex flex-col justify-between pt-20">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-7xl mx-auto px-6 w-full">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold tracking-tight sm:text-5xl">Everything you need to create</h2>
                        <p className="mt-4 text-lg text-muted-foreground">Powerful tools designed for creative coders and technical artists.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <Card className="bg-muted/50 border-none">
                            ...
                            <CardContent>
                                <CardDescription className="text-base">
                                    Construct complex materials and fragment shaders without writing a single line of GLSL. Connect math, noise, and color nodes visually.
                                </CardDescription>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-muted/50 border-none">
                            ...
                            <CardContent>
                                <CardDescription className="text-base">
                                    See your changes instantly. Our engine compiles your node graph into optimized shader code on the fly at 60 FPS.
                                </CardDescription>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-muted/50 border-none">
                            ...
                            <CardContent>
                                <CardDescription className="text-base">
                                    Save your workspaces securely to your account. Export your shaders to integrate directly into React Three Fiber or Three.js.
                                </CardDescription>
                            </CardContent>
                        </Card>
                    </div>
